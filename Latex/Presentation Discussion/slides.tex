    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
               ...
               {\scalebox{0.4}{\input{../tikz/no_control_sol1.tikz}}}
              \subfloat[][\emph{Simulation 2.}]
                {\scalebox{0.4}{\input{../tikz/no_control_sol2.tikz}}}
...
\begin{frame}{Mass Extraction}
  \begin{figure}
    \centering
    \subfloat[]{\includesvg[scale=0.165]{../../Images/masses0_1.svg}} \quad
    \subfloat[]{\includesvg[scale=0.165]{../../Images/massespi6_1.svg}}
...
\begin{frame}{Mass Extraction}
  \begin{figure}
    \centering
    \subfloat[]{\includesvg[scale=0.165]{../../Images/massespi3_1.svg}} \quad
    \subfloat[]{\includesvg[scale=0.165]{../../Images/massespi2_1.svg}}
    \caption{Joints' Decoupling.}
  \end{figure}
\end{frame}
...
\begin{frame}{Mass Extraction}
  \begin{figure}
    \centering
    \subfloat[]{\includesvg[scale=0.165]{../../Images/masses_uncoupled_1.svg}} \quad
    \subfloat[]{\includesvg[scale=0.165]{../../Images/masses_uncoupled_2.svg}}
...
\begin{frame}{Velocity Extraction}
  \begin{figure}
    \centering
    \subfloat[]{\includesvg[scale=0.165]{../../Images/velpi2_1.svg}} \quad
    \subfloat[]{\includesvg[scale=0.165]{../../Images/velpi6_1.svg}}
...
\begin{frame}{Velocity Extraction}
  \begin{figure}
    \centering
    \subfloat[]{\includesvg[scale=0.165]{../../Images/velpi2_2.svg}} \quad
    \subfloat[]{\includesvg[scale=0.165]{../../Images/velpi6_2.svg}}
